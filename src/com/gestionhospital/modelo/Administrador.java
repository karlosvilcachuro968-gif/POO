    ...
    public class Administrador extends ProfesionalSalud implements IGestionable {
        ...
        @Override
        public void registrar() { System.out.println("Administrador " + getNombre() + " registrado con usuario: " + usuario); }
        @Override
        public void editar() { System.out.println("Administrador " + getNombre() + " editado."); }
        @Override
        public void eliminar() { System.out.println("Administrador " + getNombre() + " eliminado."); }
        ...
        public void editarPaciente(Paciente paciente) { System.out.println("Editar datos del paciente: " + paciente.getNombre()); }
        public void generarReporte() { System.out.println("Generando reporte administrativo..."); }
